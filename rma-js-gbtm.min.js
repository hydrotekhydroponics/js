...
$(document).ready(function() {
	...
	function c(e) {
		var t = $(e);
		return _(t), !!/^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$/.test(t.val()) || (v(t), !1)
	}
	...
	function p(e) {
		...
		return "Store_Fax" === e.attr("name") && "" === $("[name=" + a + "]").val() || "Ship_from_customer_name" === e.attr("name") || "Pallet_weight" === e.attr("name") || "Pallet_date" === e.attr("name") || "Pallet_business_hours" === e.attr("name") || "UPS_num_box" === e.attr("name") || "UPS_faxORemail" === e.attr("name") || "Other_shipper_num_box" === e.attr("name") || "Unlisted_delevery_service" === e.attr("name") || "Unlisted_delevery_service" === e.attr("name") || "Unlisted_delevery_service" === e.attr("name") || (e.attr("name").indexOf("rma_Product_Qty") ? function(e, t) {
			if (e <= 0) return v(t), !1
		}(+$("[name=" + a + "]").val(), e) : !(!~e.attr("name").indexOf("rma_Product_Serial") && !~e.attr("name").indexOf("rma_Product_invoiceNumber") && "Ship_unit" !== e.attr("id") && ("Store_Phone" === e.attr("id") || "Store_Fax" === e.attr("id") ? (t = e, r = $(t).val(), !/^[0-9-+ ().]+$/.test(r) && (v(t), 1)) : 0 === $.trim(e.val()).length && (v(e), 1))))
	}
	...
	function v(e) {
		...
		void 0 === a ? (a = rma_error_messages[rma_lang][t], e.closest('div[rel-group="radio"]').after('<span style="color: red; display: block; clear: both">' + a + "</span>")) : $(e).after('<span style="color: red; display: block; clear: both">' + a + "</span>"),
			function(e) {
	...
	rma_lang = $("html").attr("lang"), rma_error_messages = {
		...
		var e = [],
			t = !0;
		return $("#rma_form :input").each(function(t) {
			var r = $(this).attr("name"),
				a = ($("[name=" + r + "]").attr("type"), $(this).attr("id"));
			"rma_message" === r || "rma_submit" === r || "rma_print" === r || ("rma_monotype" === r ? m = $("[name=" + r + "]").val() : "_gotcha" === r || e.push({
				name: r,
				id: "#" + a
			}))
		}), $.each(e, function(e, r) {
			return $.each(r, function(e, r) {
				"id" === e && (t = "#Ship_from_customer_email" === r || (~r.toLowerCase().indexOf("_email") ? c(r) : p(r)))
			}), t
		}), !0 === t && "" === m && confirm(rma_error_messages[rma_lang].sendMessage)
